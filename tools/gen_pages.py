...
def main():
    ...
    # The city pages this used to generate (Sydney, Melbourne, Brisbane, Adelaide,
    # Perth) were placeholder stubs and have been replaced by state pages built
    # from Helen's site list. Those are generated by tools/gen_vol_states.py from
    # data/volunteer-sites.json. Nothing to write here.
